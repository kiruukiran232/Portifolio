...
const MySkill = () => {
  const languages = [
    // C,C++,Python,Java,HTML,CSS,JavaScript,ReactJS,NodeJs,ExpressJs,Oracle,Mysql,MongoDB,Django, Machine Learning, Tomcat, Servlets
    { title: "C", icon: <FaCuttlefish className="text-red-600" /> },
  ...
  const frameworks = [
    ...
    { title: "Machine Learning", icon: <FaBrain className="text-pink-400" /> },
    { title: "Django", icon: <FaCode className="text-brown-400" /> },
  ];
  const tools = [
    { title: "MongoDB", icon: <SiMongodb className="text-green-500" /> },
    { title: "GitHub", icon: <FaGithub className="text-black" /> },
    { title: "MYSQL", icon: <FaDatabase className="text-yellow-500" /> },
